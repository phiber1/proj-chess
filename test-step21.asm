; ==============================================================================
; Step 21: Alpha-Beta Cutoffs
; Adds actual pruning logic to NEGAMAX_PLY
; ==============================================================================
;
; Changes from test-step20:
; - After updating best score, check if score >= beta
; - If so, return immediately (beta cutoff / "fail high")
; - Track cutoff count for verification
;
; Test position: WKe1 WQd1 WPa2 vs BKe8 BPa7
; With cutoffs, we should see fewer nodes than step-20
;
; ==============================================================================
...
STR_BANNER:
    DB "Step21: Alpha-Beta Cutoffs", 0DH, 0AH, 0

STR_POS:
    DB "WKe1 WQd1 WPa2 vs BKe8 BPa7", 0DH, 0AH, 0

STR_SEARCH:
    DB "Depth-2 with pruning...", 0DH, 0AH, 0
