; ==============================================================================
; Step 8: Position after 1.e4 (expect 29 moves = 0x1D)
; Tests sliding pieces can actually generate moves when not blocked
; Pawns: 15, Knights: 4, Bishop f1: 5, Queen: 4, King: 1 = 29
; ==============================================================================
...
START:
    ...
    ; Move e2 pawn to e4 (simulate 1.e4)
    LDI HIGH(BOARD)
    PHI 10
    LDI SQ_E2
    PLO 10
