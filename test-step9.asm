; ==============================================================================
; Step 9: Pawn captures (expect 31 moves = 0x1F after 1.e4 d5)
; Adds diagonal captures for pawns
; Position: 1.e4 d5 - white can play exd5
; ==============================================================================
...
; Pawn capture directions (white pawns move "south" = increasing rank)
...
START:
    ...
    PLO 10
    LDI W_PAWN
    STR 10              ; Place pawn on e4

    ; Move black d7 pawn to d5
    LDI HIGH(BOARD)
    PHI 10
    LDI SQ_D7
    PLO 10
...
; Includes: single push, double push, captures
GEN_PAWN_AT:
    ; === Single push ===
    GLO 14
    ADI DIR_S
    ...
    ANI $88
    LBNZ GPA_CAPTURES   ; Off board, skip to captures
    ...
    PLO 13
    LDN 13
    LBNZ GPA_CAPTURES   ; Blocked, skip to captures
    ...
    ANI $F0
    XRI $10
    LBNZ GPA_CAPTURES   ; Not on rank 2
...
GPA_CAPTURES:
    ; === Capture left (forward-left diagonal) ===
    GLO 14
    ADI CAP_LEFT
    PLO 11

    ANI $88
    LBNZ GPA_CAP_RIGHT  ; Off board
    ...
    PLO 13
    LDN 13
    LBZ GPA_CAP_RIGHT   ; Empty - no capture

    ; Check if enemy piece (black = bit 3 set)
    ANI COLOR_MASK
    LBZ GPA_CAP_RIGHT   ; White piece - can't capture
...
GPA_CAP_RIGHT:
    ; === Capture right (forward-right diagonal) ===
    GLO 14
    ADI CAP_RIGHT
    PLO 11

    ANI $88
    LBNZ GPA_DONE       ; Off board
    ...
    PLO 13
    LDN 13
    LBZ GPA_DONE        ; Empty - no capture

    ; Check if enemy piece
    ANI COLOR_MASK
    LBZ GPA_DONE        ; White piece - can't capture
...
; INIT_BOARD - Standard starting position
INIT_BOARD:
    LDI HIGH(BOARD)
    PHI 10
    LDI LOW(BOARD)
...
STR_BANNER:
    DB "Step9: Pawn captures", 0DH, 0AH, 0

STR_BOARD:
    DB "1.e4 d5 position", 0DH, 0AH, 0
